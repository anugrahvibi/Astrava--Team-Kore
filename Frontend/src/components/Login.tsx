      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <form onSubmit={handleLogin} className="glass-card p-10 rounded-[3rem] shadow-xl border-white/60 bg-white/70 space-y-6 premium-shadow">
          ...
          <div className="text-center pt-2">
            <Link to="/signup" className="text-[10px] font-black text-gray-400 hover:text-blue-600 transition-colors uppercase tracking-[0.15em]">
        ...
        <div className="flex items-center justify-center gap-4">
           ...
           <div className="flex items-center gap-2">
             ...
             <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">E2E Encrypted Payload</span>
           </div>
           <div className="h-px w-8 bg-gray-200" />
        </div>
      </div>
