...
export function DamOperatorDashboard() {
  ...
  return (
    <div className="p-8 h-full bg-gray-950 overflow-y-auto">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-800 pb-4">
          ...
          <div className="flex gap-4">
            <div className="bg-gray-900 border border-gray-800 px-4 py-2 rounded text-sm text-gray-400 font-mono flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="col-span-1 border border-gray-800 bg-gray-900/40 p-6 rounded-lg flex flex-col items-center justify-center">
            <h3 className="text-xs uppercase font-bold text-gray-500 tracking-widest mb-4">Reservoir Level</h3>
            <div className="relative w-40 h-40 flex items-center justify-center">
              ...
              <div className="absolute text-center">
                <div className="text-3xl font-black font-mono">{reservoirPercentage}%</div>
          ...
          <div className="col-span-1 flex flex-col gap-6">
            ...
            <div className="border border-gray-800 bg-gray-900/40 p-6 rounded-lg flex-1">
              <h3 className="text-xs uppercase font-bold text-gray-500 tracking-widest mb-4">Gate Status</h3>
              <div className="space-y-3">
                {[1, 2, 3, 4, 5].map((gate) => (
                  <div key={gate} className="flex justify-between items-center bg-gray-950 p-2 rounded border border-gray-800/50">
                    <div className="text-sm font-mono text-gray-300">Gate {gate}</div>
                    <div className={`text-xs font-bold px-2 py-1 rounded uppercase ${gate <= 2 ? 'bg-amber-500/20 text-amber-500' : 'bg-gray-800 text-gray-500'}`}>
          ...
          <div className="col-span-1 border border-gray-800 bg-gray-900/40 p-6 rounded-lg">
            <h3 className="text-xs uppercase font-bold text-gray-500 tracking-widest mb-4 flex items-center gap-2">
              <Target size={14} /> Threshold Triggers
            </h3>
            <div className="space-y-4 font-mono text-sm">
              <div className="border-l-2 border-red-500 pl-3">
                <div className="text-red-500 font-bold">2403 ft (Full Res Lvl)</div>
              ...
              <div className="border-l-2 border-blue-500 pl-3">
                <div className="text-blue-500 font-bold">2390 ft (Blue Alert)</div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-800">
                ...
                <div className="text-xl font-bold text-gray-200">2396.4 ft</div>
              </div>
            </div>
          </div>
        </div>

        <div className="border border-gray-800 bg-gray-900/40 p-6 rounded-lg mt-6 h-80">
          <h3 className="text-xs uppercase font-bold text-gray-500 tracking-widest mb-4">Inflow vs Outflow Projection (24h)</h3>
