        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-10">
          <section className="lg:col-span-2 rounded-[3rem] border-white/50 bg-white/95 backdrop-blur-3xl shadow-xl border border-white/60/50 overflow-hidden flex flex-col h-[500px] sm:h-[600px] shadow-xl premium-shadow">
             <div className="p-5 sm:p-8 border-b border-gray-100 bg-white/95 backdrop-blur-3xl shadow-xl border border-white/60/50 flex items-center justify-between">
                ...
                <div className="px-3 py-1 bg-gray-100 rounded-full text-[15px] font-black text-gray-700 uppercaseer border border-gray-200">{alerts.length} ORDERS</div>
             </div>
                     ...
                     <div key={alert.id} className="p-5 sm:p-6 rounded-3xl relative group transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 shadow-sm">
                       <div className="flex-1">
                         <div className="flex items-center gap-3 mb-2">
                            <div className="bg-blue-100/50 text-blue-700 px-3 py-1 rounded-xl text-[15px] font-black uppercase">
                               {alert.zone_id.replace('ZONE_', '')}
                            </div>
                            <AlertTriangle size={14} className="text-amber-500 opacity-70" />
                         </div>
                         <p className="text-gray-950 font-bold text-[15px] leading-relaxed mb-1">{alert.action_text}</p>
                         <div className="text-[16px] text-gray-600 font-bold uppercase italic">Source: AI-ML Structural Router</div>
                       </div>
               ...
               <div className="p-5 sm:p-8 space-y-4">
                  {[
                    ...
                    'Strategic asset retrieval'
                       ...
                       <div key={i} className="flex items-center justify-between p-4 bg-blue-50/10 border border-blue-100/50 rounded-3xl text-[15px] font-bold text-gray-700 group transition-all cursor-default overflow-hidden">
