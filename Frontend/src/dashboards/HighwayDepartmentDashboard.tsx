    ...
    <div ref={containerRef} className="pt-20 sm:pt-24 lg:pt-26 p-4 sm:p-6 lg:p-8 h-full bg-transparent overflow-y-auto w-full custom-scrollbar">
      <div className="max-w-7xl mx-auto space-y-10 py-4 sm:py-6">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-b border-black/5 pb-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl sm:text-4xl font-black text-gray-950 brand-font tracking-tight uppercase leading-none">
           ...
           <div className="flex items-center gap-3 self-stretch sm:self-auto">
             <div className="glass-card px-4 sm:px-6 py-3 sm:py-4 rounded-[1.8rem] border-white/60 bg-white/70 flex items-center gap-4 shadow-xl premium-shadow">
                <div className="text-right">
                   <div className="text-[16px] font-black text-gray-700 uppercase tracking-widest">Network Status</div>
                   <div className="text-[17px] font-black text-blue-600 uppercase tracking-widest">Connected</div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-10">
          <section className="lg:col-span-2 rounded-[3rem] border-white/50 bg-white/50 overflow-hidden flex flex-col h-[500px] sm:h-[600px] shadow-xl premium-shadow">
             <div className="p-5 sm:p-8 border-b border-gray-100 bg-white/50 flex items-center justify-between">
                ...
                <div className="px-3 py-1 bg-gray-100 rounded-full text-[17px] font-black text-gray-700 uppercase tracking-tighter border border-gray-200">{alerts.length} ORDERS</div>
             </div>
             <div className="overflow-y-auto flex-1 p-5 sm:p-8 space-y-6 custom-scrollbar">
                {alerts.length > 0 ? (
                   alerts.map((alert) => (
                     <div key={alert.id} className="p-5 sm:p-6 rounded-3xl relative group transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 shadow-sm">
                       <div className="flex-1">
                         <div className="flex items-center gap-3 mb-2">
                            <div className="bg-blue-100/50 text-blue-700 px-3 py-1 rounded-xl text-[17px] font-black uppercase tracking-widest">
                               {alert.zone_id.replace('ZONE_', '')}
                            </div>
                            <AlertTriangle size={14} className="text-amber-500 opacity-70" />
                         </div>
                         <p className="text-gray-950 font-bold text-[17px] leading-relaxed mb-1">{alert.action_text}</p>
                         <div className="text-[16px] text-gray-600 font-bold uppercase tracking-widest italic">Source: AI-ML Structural Router</div>
                       </div>
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-gray-300 opacity-40 gap-6">
                    ...
                    <p className="text-[16px] font-black uppercase tracking-[0.4em]">Operations Synchronized</p>
                  </div>
                )}
             </div>
          </section>
          ...
          <div className="space-y-6 flex flex-col">
            <div className="glass-blue p-6 sm:p-8 rounded-[2.5rem] shadow-xl space-y-4">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-[16px] font-black uppercase tracking-widest text-blue-600/60">Global Critical Window</span>
               </div>
               <div className="text-3xl sm:text-4xl font-black brand-font text-gray-900">{avgLeadTime}H</div>
               <p className="text-blue-700/60 text-[17px] font-medium leading-relaxed italic">"Model suggests logistics deployment before T-minus 4h for optimal resource retention."</p>
            </div>
               ...
               <div className="p-5 sm:p-8 space-y-4">
                  {[
                    ...
                    'Strategic asset retrieval'
                       ...
                       <div key={i} className="flex items-center justify-between p-4 bg-blue-50/10 border border-blue-100/50 rounded-3xl text-[17px] font-bold text-gray-700 group transition-all cursor-default overflow-hidden">
                         <div className="flex items-center gap-4">
                           <CheckCircle2 size={18} className="text-blue-600" />
                           <span className="uppercase tracking-wide leading-tight">{task}</span>
                         </div>
                         <ArrowRight size={28} className="text-blue-600 opacity-20 group-hover:opacity-100 group-hover:translate-x-1.5 transition-all shrink-0" />
                     </div>
                  ))}
               </div>
            </section>
