             ...
             <div className="space-y-4">
                {advisories.length > 0 ? (
                  advisories.map((alert) => (
                    <div key={alert.id} className="glass-card p-4 sm:p-6 rounded-[2.2rem] bg-white/95 backdrop-blur-3xl shadow-xl border border-white/60/50 shadow-xl premium-shadow flex items-start gap-4 sm:gap-6 group transition-transform">
                       ...
                       <div className="flex-1 space-y-2">
                          <div className="flex flex-wrap justify-between items-center gap-2">
                             <span className="text-[15px] font-black text-blue-800 uppercase break-all">{alert.zone_id} BROADCAST</span>
                             <div className="text-[16px] font-black text-gray-700 uppercaseer">T-{alert.deadline_hrs}H</div>
                          </div>
                          <p className="text-gray-950 font-bold text-[15px] leading-relaxed">{alert.action_text}</p>
                       </div>
