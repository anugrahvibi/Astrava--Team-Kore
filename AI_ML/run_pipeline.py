...
def main():
    ...
    print("  Asthrava Hackathon | Kochi, Kerala")
    print("=" * 60)

    # ── Step 1: Build infrastructure graph ──────────────────────
    print("\n[1/4] Building Kochi infrastructure dependency graph...")
    dg = DependencyGraph()
    G = dg.build()
    ...
    print(f"\n[4/4] Running What-If ROI analysis: Harden SUB_3 (Vyttila Substation)...")
    ...
    print(f"\n{'─'*60}")
    print("  ROI ANALYSIS — Harden Vyttila Substation (₹10 Lakh)")
    print(f"{'─'*60}")
