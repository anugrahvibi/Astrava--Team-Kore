...
class VisualReportGenerator:
    ...
    def generate_singularity_chart(self, top_singularities):
        ...
        plt.title('Kochi Infrastructure: Structural Singularities (Mathematical Bottlenecks)')
    ...
    def generate_lead_time_distribution(self, predictions):
        """
        Shows the lead time distribution across Kochi zones.
        """
        ...
        plt.title('Kochi Response Windows: Time-to-Peak per Zone')
